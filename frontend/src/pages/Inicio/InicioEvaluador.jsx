...
export const InicioEvaluador = ({ usuario }) => {
        ...
        <div className="col mt-4">
          <div className="row" id="descripcion-inicio">
            <div className="col-l" style={{ textAlign: 'justify' }}>
              ...
              <p className="fs-5 m-5 mt-0 mb-4">
                Cada evaluador puede <b>visualizar y completar</b> las evaluaciones que se le han asignado a través de la barra de navegación ubicada a la izquierda.
              </p>
            </div>
          </div>
