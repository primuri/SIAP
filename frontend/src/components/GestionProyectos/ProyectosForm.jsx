...
export const ProyectosForm = ({ onSubmit, mode, Proyecto, onCancel, onDelete, academicos }) => {
    // Cargar informacion
    ...
    const [formData, setFormData] = useState({
        id_documentos_asociados: Proyecto ? Proyecto.id_documentos_asociados : "",
        detalle: Proyecto ? Proyecto.detalle : "",
        documento: Proyecto ? Proyecto.documento : "",
        id_codigo_cimpa_fk: Proyecto ? Proyecto.id_codigo_cimpa_fk : {
            nombre: Proyecto ? Proyecto.id_codigo_cimpa_fk.nombre : "",
            objetivo_general: Proyecto ? Proyecto.id_codigo_cimpa_fk.objetivo_general : "",
            estado: Proyecto ? Proyecto.id_codigo_cimpa_fk.estado : "",
            actividad: Proyecto ? Proyecto.id_codigo_cimpa_fk.actividad : "",
            fecha_vigencia: Proyecto ? Proyecto.id_codigo_cimpa_fk.fecha_vigencia : "",
            descripcion: Proyecto ? Proyecto.id_codigo_cimpa_fk.descripcion : "",
            id_codigo_cimpa: Proyecto ? Proyecto.id_codigo_cimpa_fk.id_codigo_cimpa : "00-0000",
            id_colaborador_principal_fk: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk : {
                tipo: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.tipo : "Principal",
                estado: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.estado : "",
                carga: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.carga : "",
                id_vigencia_fk: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk : {
                    fecha_inicio: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk.fecha_inicio : "",
                    fecha_fin: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_vigencia_fk.fecha_fin : ""
                },
                id_academico_fk: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_academico_fk : {
                    id_academico: Proyecto && Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_academico ? Proyecto.id_codigo_cimpa_fk.id_colaborador_principal_fk.id_academico_fk.id_academico : ""
                }
            }
        }
    });
        ...
        <>
            <div className="modal-header pb-0 position-sticky top-0">
                ...
                <div className="text-center" style={{ marginLeft: '3.5vw' }}>
                    <h2>{mode == 1 ? ("Agregar una Proyecto") : ("Editar Proyecto")}</h2>
                </div>
                <div>
            ...
            <form onSubmit={sendForm} className='d-flex flex-column' encType="multipart/form-data">
                <div className="modal-body" style={{ padding: '3vh 4vw' }}>
                    <div className="container">
                        ...
                        <div className="row mb-4">
                            <div className="col-md-6">
                                <label htmlFor="estado" className="label-personalizado mb-2">Estado Proyecto <span className="required">*</span> </label>
                        ...
                        <div className="col">
                            {mode === 1 ? (
                                ...
                                <>
                                    ...
                                    {showConfirmationEdit && (<Confirmar onConfirm={sendForm} onCancel={handleEditCancel} accion="editar" objeto="Proyecto" />)}
                                </>
                            )}
                        </div>
                        <div className="col">
