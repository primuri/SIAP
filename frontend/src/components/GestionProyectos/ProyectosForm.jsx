                ...
                <div className="modal-body" style={{ padding: '3vh 4vw' }}>
                    <div className="container">
                        ...
                        <div className="row mb-4">
                            ...
                            <div className="d-flex flex-column 4">
                                <label htmlFor="colaboradores" className="label-personalizado mb-2 h5">Investigadores colaboradores secundarios <span className="disabled-input">(Opcional)</span> </label>
                    ...
                    <div className="row mb-2">
                        <div className="col d-flex justify-content-center align-items-center">
                            <h5 className="label-personalizado mb-2 col-sm-auto control-label">Agregar producto asociado</h5>
                        </div>
                    </div>
                    <div className="row mb-2">
                        <div className="col d-flex justify-content-center align-items-center">
