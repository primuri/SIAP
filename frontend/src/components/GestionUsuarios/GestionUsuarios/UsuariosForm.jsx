                        ...
                        <div className="row mb-4">
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <button type="button" className="btn ojo" style={{position: 'absolute', top: '15vh', right: '52%'}} onClick={() => setShowPassword(!showPassword)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4AACE1" className="bi bi-eye" viewBox="0 0 16 16">
