...
const excludedRoutes = new Set(['/inicio-administrador', '/inicio-evaluador', '/inicio-invitado', '/inicio-investigador', '/inicio-investigador-evaluador', '/inicio-evaluador-investigador', '/login', '/']);
