...
from .views import ProyectoViewSet, OficioViewSet, DocumentoViewSet, EvaluacionCCViewSet, RespuestaEvaluacionViewSet, PreguntaEvaluacionCCViewSet, EvaluacionViewSet, VersionProyectoViewSet, DesignacionAsistenteViewSet, ColaboradorSecundarioViewSet
...
router.register(r'respuestasevaluaciones', RespuestaEvaluacionViewSet)
