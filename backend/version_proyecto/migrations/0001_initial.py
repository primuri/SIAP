    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalle', models.CharField(blank=True, max_length=360, null=True)),
                ('documento', models.FileField(blank=True, max_length=500, null=True, upload_to='media/documentos/')),
            ],
            options={
                'db_table': 'documento',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalle', models.CharField(blank=True, max_length=128)),
                ('estado', models.CharField(max_length=128)),
                ('id_documento_evaluacion_fk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='version_proyecto.documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_evualuacion_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='version_proyecto.documento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_inopia_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='version_proyecto.documento')),
