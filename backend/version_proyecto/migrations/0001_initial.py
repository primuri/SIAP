    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.FileField(max_length=500, upload_to='media/documentos/')),
            ],
            options={
                'db_table': 'documento',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_evaluacion_fk', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='version_proyecto.documento')),
