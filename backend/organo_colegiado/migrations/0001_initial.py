    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_acta_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='version_proyecto.documento')),
            ],
            options={
                'db_table': 'acta',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_acta_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organo_colegiado.acta')),
                ('id_agenda_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organo_colegiado.agenda')),
                ('id_organo_colegiado_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organo_colegiado.organocolegiado')),
            ],
            options={
                'db_table': 'sesion',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_seguimiento_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='version_proyecto.documento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_convocatoria_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='version_proyecto.documento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_documento_acuerdo_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='version_proyecto.documento')),
                ('id_oficio_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='version_proyecto.oficio')),
                ('id_seguimiento_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organo_colegiado.seguimiento')),
                ('id_sesion_fk', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='organo_colegiado.sesion')),
            ],
            options={
                'db_table': 'acuerdo',
